    ...
    <div class="d-flex justify-content-center align-items-center my-3">
        <div class="card w-100 bg-white">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('footer/update/'. $footer['id']); ?>" method="POST" enctype="multipart/form-data">
                    <!-- Data Diri Siswa -->
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <textarea name="profile" cols="20" class="form-control border-secondary"
                                    placeholder="Masukkan Deskripsi"><?= $footer['profile'] ?></textarea>
                                <!-- ERROR -->
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <textarea name="alamat" cols="20" class="form-control border-secondary" placeholder="Masukkan alamat"><?= $footer['alamat'] ?></textarea>
                                <!-- ERROR -->
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="number" class="form-control border-secondary" name="phone" value="<?= $footer['phone'] ?>" placeholder="Masukkan Nomor Telepon">
                                <!-- ERROR -->
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="text" class="form-control border-secondary" name="email" value="<?= $footer['email'] ?>" placeholder="Masukkan Email">
                                <!-- ERROR -->
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="text" class="form-control border-secondary" name="ig" value="<?= $footer['ig'] ?>" placeholder="Masukkan Link Instagram">
                                <!-- ERROR -->
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="text" class="form-control border-secondary" name="fb" value="<?= $footer['fb'] ?>" placeholder="Masukkan Link Instagram">
                                <!-- ERROR -->
