...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-center align-items-center my-3">
        <div class="card w-100 bg-white">
            ...
            <span class="badge bg-label-dark text-center mt-4 fs-3 fw-bold text-dark">TAMBAH TAHUN AJARAN</span>
            <hr class="hr mx-4" />
            <div class="card-body">
                <?php $validation = \Config\Services::validation(); ?>

                <form action="<?= base_url('tahun_ajaran-store'); ?>" method="POST" enctype="multipart/form-data">
                    <!-- Data Diri Siswa -->
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="date" class="form-control border-secondary" name="tanggal_mulai">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="date" class="form-control border-secondary" name="tanggal_selesai">
                                <!-- ERROR -->
