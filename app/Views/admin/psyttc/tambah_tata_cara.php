...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-center align-items-center my-3">
        <div class="card w-100 bg-white">
            ...
            <span class="badge bg-label-dark text-center mt-4 fs-3 fw-bold text-dark">TAMBAH TATA CARA</span>
            <hr class="hr mx-4" />
            <div class="card-body">

                <form action="<?= base_url('tata_cara-store'); ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
