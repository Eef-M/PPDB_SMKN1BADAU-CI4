...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-center align-items-center my-3">
        <div class="card w-100 bg-white">
            <span class="badge bg-label-dark text-center mt-4 fs-3 fw-bold text-dark">TAMBAH PERSYARATAN</span>
            <hr class="hr mx-4" />
            <div class="card-body">

                <form action="<?= base_url('persyaratan-store'); ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <textarea required name="deskripsi" class="form-control summernote border-secondary w-100"></textarea>
                            </div>
                        </div>
