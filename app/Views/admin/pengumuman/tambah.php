    ...
    <div class="d-flex justify-content-center align-items-center my-3">
        <div class="card w-100 bg-white">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('pengumuman-store'); ?>" method="POST" enctype="multipart/form-data">
                    <!-- Data Diri Siswa -->
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="text" class="form-control border-secondary" name="judul" placeholder="Masukkan Judul Pengumuman">
                                <!-- ERROR -->
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <textarea name="isi" cols="20" class="form-control border-secondary" placeholder="Masukkan isi Pengumuman"></textarea>
                                <!-- ERROR -->
