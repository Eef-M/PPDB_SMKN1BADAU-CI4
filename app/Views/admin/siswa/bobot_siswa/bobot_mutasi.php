...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="card my-3">
        <div class="card-body flex-column d-flex gap-3 ">
            <h5 class="card-title">Bobot Nilai Siswa <span class="text-success fw-bold">Mutasi</span></h5>
            <div class="d-flex justify-content-end align-items-center w-100 gap-2">
                <?php if (empty($mutasi)) {
                    null;
                } else { ?>
                    <a href="<?= base_url('mutasi-excel'); ?>" class="btn d-flex justify-content-center align-items-center gap-2" style="background-color: #379237; color: white;">
