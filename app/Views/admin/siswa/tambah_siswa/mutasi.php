                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nama_siswa"
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="tempat_lahir"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <textarea class="form-control border-success" name="alamat" rows="2"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="kelurahan"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="kecamatan"
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="kab_kota"
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="provinsi"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nohp_siswa"
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nama_ayah"
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nik_ayah"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nama_ibu"
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nik_ibu"
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nohp_ortu"
