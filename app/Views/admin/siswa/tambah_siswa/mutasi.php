...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-center align-items-center my-3">
        <div class="card w-100 bg-white">
            ...
            <span class="badge bg-label-success text-center fs-5 fw-bold">JALUR MUTASI</span>
            <hr class="hr mx-4" />
            <div class="card-body">
                ...
                <form action="<?= base_url('siswa-store'); ?>" method="POST" enctype="multipart/form-data">
                    <!-- Data Diri Siswa -->
                    <span class="badge bg-label-success rounded mb-4 px-3 py-2 fs-6 shadow-sm">Data Diri Siswa</span>
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="text" class="form-control border-success" disabled value="<?= $date; ?>">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nisn" placeholder="Masukkan NISN Anda">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nik" placeholder="Masukkan NIK Anda">
                                <!-- ERROR -->
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nama_siswa" placeholder="Masukkan Nama Lengkap Anda">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <select aria-label="Default select example" class="form-control border-success" name="jenis_kelamin">
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="tempat_lahir" placeholder="Masukkan Tempat Lahir Anda">
                                <!-- ERROR -->
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="date" class="form-control border-success" name="tanggal_lahir">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <select aria-label="Default select example" class="form-control border-success" name="agama">
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <select aria-label="Default select example" class="form-control border-success" name="status_dlm_kel">
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <textarea class="form-control border-success" name="alamat" rows="2" placeholder="Masukkan Alamat Anda"></textarea>
                                <!-- ERROR -->
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="rt" placeholder="Masukkan RT">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="rw" placeholder="Masukkan RW">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="kelurahan" placeholder="Masukkan Kelurahan">
                                <!-- ERROR -->
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="kecamatan" placeholder="Masukkan Kecamatan">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="kab_kota" placeholder="Masukkan Kabupaten/Kota">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="provinsi" placeholder="Masukkan Provinsi">
                                <!-- ERROR -->
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nohp_siswa" placeholder="Masukkan Telepon/No. Hp Anda">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nama_ayah" placeholder="Masukkan Nama Ayah Anda">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nik_ayah" placeholder="Masukkan NIK Ayah Anda">
                                <!-- ERROR -->
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-4 flex-column flex-lg-row w-100">
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nama_ibu" placeholder="Masukkan Nama Ibu Anda">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nik_ibu" placeholder="Masukkan NIK Ibu Anda">
                                <!-- ERROR -->
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="nohp_ortu" placeholder="Masukkan Telepon/No. Hp Ayah/Ibu Anda">
                                <!-- ERROR -->
                    ...
                    <span class="badge bg-label-success rounded my-4 px-3 py-2 fs-6 shadow-sm">Nilai Mata Pelajaran</span>
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bindo_1" style="width: 80px; height: 50px;" id="bindo_1">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bindo_2" style="width: 80px; height: 50px;" id="bindo_2">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bindo_3" style="width: 80px; height: 50px;" id="bindo_3">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bindo_4" style="width: 80px; height: 50px;" id="bindo_4">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bindo_5" style="width: 80px; height: 50px;" id="bindo_5">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bing_1" style="width: 80px; height: 50px;" id="bing_1">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bing_2" style="width: 80px; height: 50px;" id="bing_2">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bing_3" style="width: 80px; height: 50px;" id="bing_3">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bing_4" style="width: 80px; height: 50px;" id="bing_4">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="bing_5" style="width: 80px; height: 50px;" id="bing_5">
                                ...
                                <tr>
                                    <td>Matematika</td>
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="mtk_1" style="width: 80px; height: 50px;" id="mtk_1">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="mtk_2" style="width: 80px; height: 50px;" id="mtk_2">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="mtk_3" style="width: 80px; height: 50px;" id="mtk_3">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="mtk_4" style="width: 80px; height: 50px;" id="mtk_4">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="mtk_5" style="width: 80px; height: 50px;" id="mtk_5">
                                ...
                                <tr>
                                    <td>IPA</td>
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ipa_1" style="width: 80px; height: 50px;" id="ipa_1">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ipa_2" style="width: 80px; height: 50px;" id="ipa_2">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ipa_3" style="width: 80px; height: 50px;" id="ipa_3">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ipa_4" style="width: 80px; height: 50px;" id="ipa_4">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ipa_5" style="width: 80px; height: 50px;" id="ipa_5">
                                ...
                                <tr>
                                    <td>IPS</td>
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ips_1" style="width: 80px; height: 50px;" id="ips_1">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ips_2" style="width: 80px; height: 50px;" id="ips_2">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ips_3" style="width: 80px; height: 50px;" id="ips_3">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ips_4" style="width: 80px; height: 50px;" id="ips_4">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control border-success" name="ips_5" style="width: 80px; height: 50px;" id="ips_5">
                    ...
                    <!-- Upload Berkas -->
                    <span class="badge bg-label-success rounded my-4 px-3 py-2 fs-6 shadow-sm">Upload Berkas</span>
                    <div class="d-flex flex-column justify-content-center align-items-start gap-3">
                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="foto" required>
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="kartu_keluarga" required>
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="scan_nisn" required>
                                <span class="text-secondary fst-italic mt-2" style="font-size: 14px;">Format file PDF. Max 10MB</span>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="rpt_smstr_1sd5" required>
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="st_ortu" required>
                                <span class="text-secondary fst-italic mt-2" style="font-size: 14px;">Format file PDF. Max 10MB</span>
                            </div>
                        </div>
                        <?php if (empty($jurusan)) : ?>
