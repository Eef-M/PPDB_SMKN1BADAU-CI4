        ...
        <div class="card w-100 bg-white">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('siswa-store'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input type="date" class="form-control border-success" name="tanggal_pendaftaran">
                                <!-- ERROR -->
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                ...
                                <input class="form-control border-success" name="status_dlm_kel"
                    ...
                    <span class="badge bg-label-success rounded my-4 px-3 py-2 fs-6 shadow-sm">Nilai Mata
                        Pelajaran</span>
                    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input name="bindo_1" class="form-control border-success"
                                    ...
                                    <td class="text-center">
                                        <input name="bindo_2" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="bindo_3" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="bindo_4" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="bindo_5" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input name="bing_1" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="bing_2" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="bing_3" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="bing_4" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="bing_5" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                ...
                                <tr>
                                    <td>Matematika</td>
                                    <td class="text-center">
                                        <input name="mtk_1" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="mtk_2" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="mtk_3" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="mtk_4" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="mtk_5" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                ...
                                <tr>
                                    <td>IPA</td>
                                    <td class="text-center">
                                        <input name="ipa_1" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="ipa_2" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="ipa_3" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="ipa_4" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="ipa_5" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                ...
                                <tr>
                                    <td>IPS</td>
                                    <td class="text-center">
                                        <input name="ips_1" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="ips_2" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="ips_3" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="ips_4" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                                    ...
                                    <td class="text-center">
                                        <input name="ips_5" class="form-control border-success"
                                            style="width: 50px; height: 50px;">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start gap-3">
                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="foto">
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="kartu_keluarga">
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="scan_nisn">
                        ...
                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="rpt_smstr_1">
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="rpt_smstr_2">
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="rpt_smstr_3">
                        ...
                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="rpt_smstr_4">
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="rpt_smstr_5">
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3 w-100">
                                ...
                                <input type="file" class="form-control border-success" name="st_ortu">
                            </div>
                        </div>
