        ...
        <div class="col-sm-9">
            ...
            <section class="section bg-light">
                <div class="d-flex justify-content-center align-items-center mx-auto flex-column px-4">
                    ...
                    <form action="<?= base_url('user-store'); ?>" id="multiple-steps-form" class="w-100 mt-3"
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nisn" name="nisn" class="form-control border-primary"
                                            required placeholder="Masukkan NISN Anda" value="<?= user()->nisn; ?>"
                                            readonly>
                                        <div class="invalid-feedback">
                                            NISN harus diisi.
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nik" name="nik" class="form-control border-primary"
                                            required placeholder="Masukkan NIK Anda">
                                        <div class="invalid-feedback">
                                            NIK harus diisi.
                                        </div>
                                    </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="status_dlm_kel" name="status_dlm_kel"
                                            class="form-control border-primary" required
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="rt" name="rt" class="form-control border-primary"
                                            required placeholder="Masukkan RT">
                                        <div class="invalid-feedback">
                                            RT harus diisi.
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="rw" name="rw" class="form-control border-primary"
                                            required placeholder="Masukkan RW">
                                        <div class="invalid-feedback">
                                            RW harus diisi.
                                        </div>
                                    </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nohp_siswa" name="nohp_siswa"
                                            class="form-control border-primary" required
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nohp_ortu" name="nohp_ortu"
                                            class="form-control border-primary" required
                        ...
                        <div class="step" id="step-berkas">
                            ...
                            <div class="d-flex justify-content-center align-items-start flex-column mb-3">
                                ...
                                <div class="invalid-feedback">
                                    Surat Tugas Orang Tua harus diunggah.
                                </div>
                            </div>
